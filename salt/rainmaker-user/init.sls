...
/home/rainmaker/.ssh/id_rsa.pub:
  file.managed:
    - source: salt://rainmaker/image-server/rainmaker-user/files/rainmaker_id_rsa.pub
    - user: rainmaker
    - group: rainmaker
    - mode: 600
    - replace: False
...
/home/rainmaker/.ssh/authorized_keys:
  file.managed:
    - source: salt://rainmaker/image-server/rainmaker-user/files/rainmaker_authorized_keys
    - user: rainmaker
    - group: rainmaker
    - mode: 600
    - replace: False
...
/etc/sudoers.d/rainmaker:
  file.managed:
    - source: salt://rainmaker/image-server/rainmaker-user/files/rainmaker_sudoers
    - user: root
    - group: root
    - mode: 400
    - replace: True
